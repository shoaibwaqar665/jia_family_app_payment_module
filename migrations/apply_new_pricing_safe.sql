-- ============================================
-- Apply New Jia Pricing Structure (Safe Version)
-- ============================================
-- This script safely updates plans by handling foreign key constraints
-- Database: jia_family_app
-- Date: October 2025
-- ============================================

-- Step 1: Temporarily disable foreign key constraints
ALTER TABLE entitlements DROP CONSTRAINT IF EXISTS fk_entitlements_plan_id;

-- Step 2: Delete all existing plans
DELETE FROM plans;

-- Step 3: Insert new pricing structure
...
-- Step 5: Update any orphaned entitlements to point to basic_free plan
UPDATE entitlements 
SET plan_id = 'basic_free' 
